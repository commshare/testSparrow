...
#define LOGW(message,...)  __android_log_print(ANDROID_LOG_ERROR, LOG_TAG,"[%s_%d_%s]"message,__FILE__,__LINE__,__FUNCTION__,##__VA_ARGS__)
...
#define slogw(message,...) __android_log_print(ANDROID_LOG_WARN, LOG_TAG,"##"message,##__VA_ARGS__)
...
#define sc_die(format,...) \
	__android_log_print(ANDROID_LOG_ERROR, LOG_TAG, "[%s_%d_%s]"format,__FILE__,__LINE__,__FUNCTION__,##__VA_ARGS__);\
...
if(level > debuglev ) \
	return; \
__android_log_print(ANDROID_LOG_DEBUG, LOG_TAG, "[%s_%d_%s]"format,__FILE__,__LINE__,__FUNCTION__,##__VA_ARGS__)

#define sc_warn(format,...)  __android_log_print(ANDROID_LOG_ERROR, LOG_TAG,"[%s_%d_%s]"format,__FILE__,__LINE__,__FUNCTION__,##__VA_ARGS__)

//add by me 20141106
//#define dprintf(fmt,arg...) __android_log_print(ANDROID_LOG_INFO, LOG_TAG, "[%s_%d_%s]"fmt,arg,__FILE__,__LINE__,__FUNCTION__,##__VA_ARGS__)

//#define vdprintf(fmt,arg...) __android_log_print(ANDROID_LOG_INFO, LOG_TAG, "[%s_%d_%s]"fmt,arg,__FILE__,__LINE__,__FUNCTION__,##__VA_ARGS__)

...
ANDROID_NDK_DIR=/home/zhangbin/android/ndk_r13b
...
# https://github.com/adavari/FFMpegAndroid/blob/master/build_android.sh
FEATURES_2="    --enable-decoder=aac,h264,mpeg4 \
...
HOST_INFO= `basename  $ANDROID_NDK_DIR/toolchains/*/prebuilt/*`
echo "HOST_INFO  IS  $HOST_INFO"
#HOST_OS= `echo $HOST_INFO | basename | head -n 1`

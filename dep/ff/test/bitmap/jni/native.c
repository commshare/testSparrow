...
void Java_sc_ffbitmap_MainActivity_openFile(JNIEnv * env, jobject this)
{
    int ret;
    int err;
    int i;
    ...
    char * filename= "/mnt/sdcard/zhangbin/wild.mp4";
...
void Java_sc_ffbitmap_MainActivity_drawFrameAt(JNIEnv * env, jobject this, jstring bitmap, jint secs)
{
    AndroidBitmapInfo  info;
    void*              pixels;
    int                ret;

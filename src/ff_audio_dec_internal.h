#ifndef __SC_AUDIO_DEC_INTERNAL_H_
#define __SC_AUDIO_DEC_INTERANL_H_

#include"sc_type.h"

typedef uint16_t SC_AudioFormat;
...
#if 0
typedef struct SC_AudioSpec
{
    int freq;                   /**< DSP frequency -- samples per second *///这个就是采样率啊
    SC_AudioFormat format;     /**< Audio data format */
